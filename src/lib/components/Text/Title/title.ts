...
export const title = {
   class: {
      ...
      color: ( type: TitleType = 'h1' ) => {
         switch (type) {
            case 'h1': return 'text-primary-600';
            case 'h2': return 'text-primary-600';
            case 'h3': return 'text-primary-700';
            case 'h4': return 'text-primary-700';
            case 'h5': return 'text-primary-800';
            case 'h6': return 'text-primary-900';
         }
      },
